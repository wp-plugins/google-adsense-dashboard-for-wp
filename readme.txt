...
Google Adsense Dashboard main features:
...
* <a href="http://www.deconf.com/en/projects/google-adsense-dashboard-for-wordpress/" title="Google Adsense Dashboard Plugin">Google Adsense Dashboard Plugin Homepage</a>
* <a href="http://forum.deconf.com/en/wordpress-plugins-f182/" title="Google Adsense Dashboard Plugin">Google Adsense Dashboard Plugin Support</a>

== Installation ==

1. Upload the full directory into your wp-content/plugins directory
2. Activate the plugin at the plugin administration page
3. Open the plugin configuration page, which is located under Settings -> GAds Dashboard (optionally enter your API Key, Client Secret and Client ID).
4. Authorize the application using the 'Authorize Application' button
5. Go back to the plugin configuration page, which is located under Settings -> GAds Dashboard to update the final settings.
...
2. Google Adsense Dashboard custom channels and ad units report table
3. Google Adsense Dashboard Settings
